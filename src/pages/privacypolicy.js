            ...
            <div className='pb-28' >
                <div className='lg:hidden'>
                    <div className='flex  items-center mt-5 w-full'>
                        ...
                        <div className='w-full text-center'>
                            <h1 className=" font-normal text-[20px]  me-5">Privacy Policy</h1>
                        </div>
                    </div>
                </div>
                ...
                <div className='flex flex-col lg:flex-row lg:w-full lg:justify-center lg:items-start'>
                    <div className='lg:w-[60%]'>
                        <div className='hidden lg:block font-normal mt-5 lg:mx-12'> <p className='text-[40px]'>Privacy Policy</p>
                            <p className='text-[20px] font-medium'>
                                <span className={lexend_exa.className}> Last updated: May 15, 2023</span></p></div>
                        <div className='mx-5 text-justify text-[16px] font-normal lg:mx-12 mt-5 bg-[#D5D5D5] lg:text-[20px] lg:p-5 pb-12'><div className={lexend_exa.className}>
                            ...
                            <p className='my-3'>Interpretation and Definitions <br />
